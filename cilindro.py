...
# Creazione della GIF
# scegliamo le immagini da incorporare nella GIF
# ogni 20 immagini
image_paths = image_paths[::20] + image_paths[-1:]  # aggiungiamo l'ultima immagine

with imageio.get_writer('flow_simulation_cilindro.gif', mode='I') as writer:
